export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	cometoss: {
		...
		name: "Cometoss",
		types: ["Ice", "Rock"],
		baseStats: {hp: 75, atk: 49, def: 103, spa: 135, spd: 50, spe: 113},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 560,
		color: "Brown",
	...
	harsqoon: {
		...
		name: "Harsqoon",
		types: ["Dark", "Water"],
		baseStats: {hp: 215, atk: 140, def: 55, spa: 35, spd: 55, spe: 40},
	...
	zheonix: {
		...
		name: "Zheonix",
		types: ["Flying", "Fire"],
		baseStats: {hp: 62, atk: 43, def: 60, spa: 111, spd: 108, spe: 116},
